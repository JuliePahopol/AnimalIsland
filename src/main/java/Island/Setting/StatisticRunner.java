...
import Island.AnimalSetting.AnimalSpecies;
...
import static Island.Plant.Plant.PLANT_ICON;
...
public class StatisticRunner implements Runnable{
    ...
    private final Map<String, Integer> quantityOfLivingBeings = new HashMap<>();
